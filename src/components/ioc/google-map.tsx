...
export default function GoogleMap({ 
  ...
  apiUrl = 'http://43.216.228.155:3001/api/blok_perancangan'
}: GoogleMapProps) {
  ...
  const loadPasarAwamData = async (map: any, dataLayer: any) => {
    return loadPasarData(
      map,
      dataLayer,
      'http://43.216.228.155:3001/api/pasar_awam',
      'pasar_awam',
      setPasarAwamData,
      pasarAwamMarkersRef,
      pasarAwamData
  ...
  const loadPasarMalamData = async (map: any, dataLayer: any) => {
    return loadPasarData(
      map,
      dataLayer,
      'http://43.216.228.155:3001/api/pasar_malam',
      'pasar_malam',
      setPasarMalamData,
  ...
  const loadPasarSariData = async (map: any, dataLayer: any) => {
    return loadPasarData(
      map,
      dataLayer,
      'http://43.216.228.155:3001/api/pasar_sari',
      'pasar_sari',
      setPasarSariData,
      pasarSariMarkersRef,
      pasarSariData
  ...
  const loadPasarTaniData = async (map: any, dataLayer: any) => {
    return loadPasarData(
      map,
      dataLayer,
      'http://43.216.228.155:3001/api/pasar_tani',
      'pasar_tani',
      setPasarTaniData,
      pasarTaniMarkersRef,
      pasarTaniData
